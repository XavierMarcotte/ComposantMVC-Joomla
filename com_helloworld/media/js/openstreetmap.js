...
jQuery(document).ready(function () {
  ...
  map = new ol.Map({
    ...
    layers: [
      new ol.layer.Tile({
        // we'll get the tiles from the OSM server
        source: new ol.source.OSM(),
      }),
    ],
    view: new ol.View({
      // default is Spherical Mercator projection
      center: mapCentre,
      zoom: params.zoom,
    }),
  });
  ...
  var helloworldPoint = new ol.Feature({
...
function getMapBounds() {
  ...
  var latlngMapbounds = ol.proj.transformExtent(
    mercatorMapbounds,
    "EPSG:3857",
    "EPSG:4326"
  );
